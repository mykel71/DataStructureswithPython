...
class PrefixSum:
    ...
    def get_sum(self, start: int, end: int) -> bool:
        """
        The func returns the sum of arr from the start to the end indexes.
        Runtime : O(1)
        Space : O(1)
    ...
    def contains_sum(self, target_sum: int) -> bool:
        """
        The func returns true if array contains the target_sum, False otherwise
